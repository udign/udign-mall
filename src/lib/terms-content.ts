...
이 약관은 UDIGN 회사(전자상거래 사업자로 이하 "회사"라 한다)가 운영하는 UDIGN 쇼핑몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
...
3. 사업종목의 전환, 사업의 포기, 업체간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 "몰"은 제 8조에 정한 방법으로 이용자에게 통지하고 당초 "몰"에서 제시한 조건에 따라 소비자에게 보상합니다. 다만, "몰"이 보상기준 등을 고지하지 아니한 경우에는 이용자들의 마일리지 또는 적립금 등을 "몰"에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.
...
2. "몰"은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각호에 해당하지 않는 한 회원으로 등록합니다.
   가. 가입신청자가 이 약관 제 7조 제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제 7조 제3항에 의한 회원자격 상실후 3년이 경과한 자로서 "몰"의 회원재가입 승낙을 얻은 경우에는 예외로 한다.
...
2. 회원이 다음 각호의 사유에 해당하는 경우, "몰"은 회원자격을 제한 및 정지시킬 수 있습니다.
   ...
   나. "몰"을 이용하여 구입한 재화등의 대금, 기타 "몰"이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우
   다. 다른 사람의 "몰" 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우
   라. "몰"을 이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우
...
1. "몰"이용자는 "몰"상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, "몰"은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.
   ...
   라. 이 약관에 동의하고 위 3.호의 사항을 확인하거나 거부하는 표시 (예, 마우스 클릭)
   마. 재화 등의 구매신청 및 이에 관한 확인 또는 "몰"의 확인에 대한 동의
   바. 결제방법의 선택
2. "몰"이 제3자에게 구매자 개인정보를 제공·위탁할 필요가 있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때 "몰"은 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유ㆍ이용 기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제 25조 제1항에 의한 개인정보 취급위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.

제10조 계약의 성립

1. "몰"은 제 9조와 같은 구매신청에 대하여 다음 각호에 해당하면 승낙하지 않을 수 있습니다. 다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자 본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지하여야 합니다.
   가. 신청 내용에 허위, 기재누락, 오기가 있는 경우
   나. 미성년자가 담배, 주류등 청소년보호법에서 금지하는 재화 및 용역을 구매하는 경우
   다. 기타 구매신청에 승낙하는 것이 "몰" 기술상 현저히 지장이 있다고 판단하는 경우
2. "몰"의 승낙이 제 12조 제1항의 수신확인통지형태로 이용자에게 도달한 시점에 계약이 성립한 것으로 봅니다.
...
2. 수신확인통지를 받은 이용자는 의사표시의 불일치 등이 있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고 "몰"은 배송 전에 이용자의 요청이 있는 경우에는 지체 없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제 15조의 청약철회 등에 관한 규정에 따릅니다.
...
1. "몰"과 재화 등의 구매에 관한 계약을 체결한 이용자는 "전자상거래 등에서의 소비자보호에 관한 법률" 제 13조 제2항에 따른 계약내용에 관한 서면을 받은 날(그 서면을 받은 때보다 재화 등의 공급이 늦게 이루어진 경우에는 재화 등을 공급받거나 재화 등의 공급이 시작된 날을 말합니다)부터 7일 이내에는 청약의 철회를 할 수 있습니다. 다만, 청약철회에 관하여 "전자상거래 등에서의 소비자보호에 관한 법률"에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다.
...
1. "몰"은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 "몰"이 이용자에게 재화등의 환급을 지연한때에는 그 지연기간에 대하여 "전자상거래 등에서의 소비자보호에 관한 법률 시행령" 제 21조의 2에서 정하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.
...
5. "몰"이 제3항과 제4항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 "정보통신망 이용촉진 및 정보보호 등에 관한 법률" 제 22조 제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.
...
3. "몰"이 상품이나 용역에 대하여 "표시ㆍ광고의 공정화에 관한 법률" 제 3조 소정의 부당한 표시ㆍ광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다.
...
부  칙 시행일 등
본 방침은 2025년 O4월 O1일부터 시행합니다.`;

export const termsOfUpload = `
★ (디자이너 회원의 의무/책임) ★

디자인을 업로드하고자 하는 회원은 (주) 유다인이 규정한 업로드 금지 디자인 사항을 제외한 디자인만을 업로드를 하여야 합니다.

-----------(업로드 금지 디자인 사항)------------

1. 타인의 저작권, 디자인권, 지적재산권을 직간접적으로 침해한 디자인
(단, 오마주/패러디 등은 본사 논의 후 승인 가능)
(콜라보는 승인-단, 유다인 앰블럼 부착 필수)

2. 안전하지 않은 디자인

3. 혐오감을 조성하는 잔인한 디자인

4. 폭력/약물/자살/테러 등 범죄와 관련되었거나 반사회적인 메세지를 선전하는 디자인

5. 인권 침해, 혐오, 차별의 디자인

6. 국제 사회에서 분쟁을 야기할 수 있는 디자인
(단, 인도주의, 인류애의 목적이 분명한 디자인은 승인)
 
7. 특정 종교를 비난하거나 비방하는 디자인

8. 본사(유다인)을 직간접적으로 비방/비난하는 디자인

9. 외설적, 선정적인 디자인 

10. 위생적으로 심리적 불쾌함을 유발하는 디자인
(단, 이미지나 문구가 심각하게 불쾌감을 주지 않는다면 승인 가능)  

11. 중요 보안 사항 관련 디자인

12. 개별적 목적의 선전/홍보 디자인

13. 비방/비하/욕설 관련 디자인
(단, 심각한 수위가 아니면 승인 가능)

14. 정치적 중립성을 훼손하는 디자인

15. 타인의 초상권을 침해하는 디자인
(단, 본인이거나/해당 인물과 명백한 협의 증거가 존재하는 경우 승인 가능)

16. 도용된 사진, 이미지 디자인

17. 특정 상표를 연상시키는 디자인

18. 단순 반복적, 도배성이 짙은 디자인

19. 기존 유다인(www.udign.com) 홈페이지에 있는 디자인을 도용한 디자인
(단, 해당 디자인의 명확한 차별성이 존재한다면 별개의 디자인으로 승인 가능) 

20. 라이센스가 있는 어떠한 이름/이미지 등등이 연상되는 디자인

21. 명예를 실추시키거나 동의 없이 해당 대상을 직간접적으로 언급한 디자인

----------------------------------------------

◆ 본 유다인의 업로드 금지 디자인 사항과 관련하여 이를 위반하여 발생된 모든 사안들에 대해 법적 책임 및 관련 소송의 제반 비용은 해당 회원 개인이 부담하고, (주) 유다인은 면책됩니다.

◆ 디자인을 업로드 하려는 회원은 다음 업로드 관련 약관 사항들을 숙지해야하며 약관의 동의를 함으로써 회원은 이를 숙지했으며 이를 준수하겠다는 의사를 표명한 것으로 봅니다. 
디자이너 업로드 시 회원은 (주) 유다인의 디자인 업로드 관련 정책 내용을 이해하였고 약관 안내 사항의 동의 시 해당 사항들을 이행할 의무를 부담합니다.

◆ 유다인 업로드 금지 디자인 사항에 관해 이를 위반한 것으로 보이는 디자인에 대해서 회사는 디자인 승인을 반려, 삭제할 수 있으며 해당 사유는 등록된 디자이너의 SMS로 개별 통지합니다. 회원은 해당 디자인에 대해 디자인 수정 후 재업로드 할 수 있습니다.                                
`;
